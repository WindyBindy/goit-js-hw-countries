...
if (inputRef) inputRef.addEventListener('input', (0, _lodashDebounceDefault.default)(searchCountry, 500));
function searchCountry(event) {
    const countryName = event.target.value.trim();
    countreList.innerHTML = "";
    (0, _fetchCountriesJsDefault.default)(countryName).then((res)=>{
        if (res.length > 10) {
            (0, _pnotifyJs.error)({
...
},{}],"c4y47":[function() {},{}],"iv3sV":[function() {},{}],"grIyt":[function() {},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire4b08", {})

//# sourceMappingURL=goit-js-hw-countries.31b563d9.js.map
